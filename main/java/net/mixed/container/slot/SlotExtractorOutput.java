...
public class SlotExtractorOutput extends Slot {
	...
	public SlotExtractorOutput(EntityPlayer player, IInventory inventoryIn, int slotIndex, int xPosition, int yPosition) {
	...
	protected void onCrafting(ItemStack stack) {
		...
		if(!this.player.world.isRemote) {
			...
			float f = ExtractorRecipes.instance().getSmeltingExperience(stack);
