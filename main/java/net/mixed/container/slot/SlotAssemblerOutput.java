package net.mixed.container.slot;
...
public class SlotAssemblerOutput extends Slot {
	...
	public SlotAssemblerOutput(EntityPlayer player, IInventory inventoryIn, int slotIndex, int xPosition, int yPosition) {
	...
	protected void onCrafting(ItemStack stack) {
		...
		if(!this.player.world.isRemote) {
			...
			float f = AssemblerRecipes.instance().getSmeltingExperience(stack);
